...
description: Use to write or improve developer-facing documentation — project READMEs, setup/getting-started guides, CLAUDE.md, usage docs, API/reference docs. Not for game/feature design documents (use the design-doc skill) and not for marketing or portfolio copy (use content tooling). Triggers — "write a README for this," "document how to set up / run this," "improve these setup docs," "write a getting-started guide."
